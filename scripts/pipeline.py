...
def train_model_1():
    try:
        ...
        if current_task:
            ...
            new_task = Task.init(
                project_name="my_mlops_project", task_name="train_with_clearml_1"
            )
            ...
            subprocess.run(
                ["python", "scripts/train.py", "--model-type", "model_1"], check=True
            )
...
def train_model_2():
    try:
        ...
        if current_task:
            ...
            new_task = Task.init(
                project_name="my_mlops_project", task_name="train_with_clearml_2"
            )
            ...
            subprocess.run(
                ["python", "scripts/train.py", "--model-type", "model_2"], check=True
            )
